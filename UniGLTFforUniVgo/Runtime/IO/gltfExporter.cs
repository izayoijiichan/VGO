    ...
    public class gltfExporter : IDisposable
    {
        ...
        protected virtual IEnumerable<string> ExtensionUsed
        {
            get
            {
                ...
                yield return KHR_texture_transform.ExtensionName;
            }
        }

        /// <summary>Names of glTF extensions required to properly load this asset.</summary>
        protected virtual IEnumerable<string> ExtensionsRequired
        {
            get
            {
                yield return KHR_materials_unlit.ExtensionName;
        ...
        public gltfExporter(glTF gltf)
        {
            ...
            glTF.extensionsRequired.AddRange(ExtensionsRequired);
