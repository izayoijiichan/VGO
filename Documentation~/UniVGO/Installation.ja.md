...
|UniVGO2|IzayoiJiichan|GitHub|VGO 2.1|2.1.2|2021年1月31日|
...
Unity Hub にて`Unity 2019.4.18f1`をインストールします。
...
```json
{
  ...
  "dependencies": {
    ...
    "izayoi.univgo2": "https://github.com/izayoijiican/VGO2.git#v2.1.2",
