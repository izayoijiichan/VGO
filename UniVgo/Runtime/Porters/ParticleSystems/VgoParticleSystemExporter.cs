...
namespace UniVgo.Porters
{
    ...
    public class VgoParticleSystemExporter
    {
        ...
        /// <summary>
        /// Create VGO_ParticleSystem.
        /// </summary>
        /// <param name="particleSystem"></param>
        /// <param name="particleSystemRenderer"></param>
        /// <param name="gltfStorageAdapter"></param>
        /// <param name="exportTexture"></param>
        /// <returns></returns>
        public virtual VGO_ParticleSystem Create(ParticleSystem particleSystem, ParticleSystemRenderer particleSystemRenderer, GltfStorageAdapter gltfStorageAdapter, ExportTextureDelegate exportTexture)
        {
            ...
            var vgoParticleSystem = new VGO_ParticleSystem()
            {
                main = CreateVgoModule(particleSystem.main),
                emission = CreateVgoModule(particleSystem.emission),
                shape = CreateVgoModule(particleSystem.shape, gltfStorageAdapter, exportTexture),
                ...
                renderer = CreateVgoPsRenderer(particleSystemRenderer, gltfStorageAdapter.Gltf),
            };
        ...
        protected virtual VGO_PS_MainModule CreateVgoModule(MainModule module)
        {
            var vgoModule = new VGO_PS_MainModule()
            {
                ...
                simulationSpace = (VgoGltf.ParticleSystemSimulationSpace)module.simulationSpace,
                ...
                scalingMode = (VgoGltf.ParticleSystemScalingMode)module.scalingMode,
                playOnAwake = module.playOnAwake,
                emitterVelocityMode = (VgoGltf.ParticleSystemEmitterVelocityMode)module.emitterVelocityMode,
                maxParticles = module.maxParticles,
                stopAction = (VgoGltf.ParticleSystemStopAction)module.stopAction,
                cullingMode = (VgoGltf.ParticleSystemCullingMode)module.cullingMode,
                ringBufferMode = (VgoGltf.ParticleSystemRingBufferMode)module.ringBufferMode,
            };
        ...
        /// <param name="exportTexture"></param>
        /// <returns></returns>
        protected virtual VGO_PS_ShapeModule CreateVgoModule(ShapeModule module, GltfStorageAdapter gltfStorageAdapter, ExportTextureDelegate exportTexture)
        {
            var vgoShapeModule = new VGO_PS_ShapeModule()
            {
                enabled = module.enabled,
                shapeType = (VgoGltf.ParticleSystemShapeType)module.shapeType,
                angle = module.angle,
                radius = module.radius,
                donutRadius = module.donutRadius,
                radiusMode = (VgoGltf.ParticleSystemShapeMultiModeValue)module.radiusMode,
                ...
                arc = module.arc,
                arcMode = (VgoGltf.ParticleSystemShapeMultiModeValue)module.arcMode,
                ...
                meshShapeType = (VgoGltf.ParticleSystemMeshShapeType)module.meshShapeType,
                meshSpawnMode = (VgoGltf.ParticleSystemShapeMultiModeValue)module.meshSpawnMode,
                ...
                textureIndex = -1,
                textureClipChannel = (VgoGltf.ParticleSystemShapeTextureChannel)module.textureClipChannel,
                ...
                position = module.position.ReverseZ().ToNumericsVector3(),
                rotation = module.rotation.ToNumericsVector3(),
                scale = module.scale.ToNumericsVector3(),
            ...
            {
                vgoShapeModule.textureIndex = exportTexture(material: null, module.texture, propertyName: null);
            }
        ...
        protected virtual VGO_PS_VelocityOverLifetimeModule CreateVgoModule(VelocityOverLifetimeModule module)
        {
            return new VGO_PS_VelocityOverLifetimeModule()
            {
                ...
                space = (VgoGltf.ParticleSystemSimulationSpace)module.space,
        ...
        protected virtual VGO_PS_InheritVelocityModule CreateVgoModule(InheritVelocityModule module)
        {
            ...
            {
                enabled = module.enabled,
                mode = (VgoGltf.ParticleSystemInheritVelocityMode)module.mode,
        ...
        protected virtual VGO_PS_ExternalForcesModule CreateVgoModule(ExternalForcesModule module)
        {
            return new VGO_PS_ExternalForcesModule()
            {
                ...
                influenceFilter = (VgoGltf.ParticleSystemGameObjectFilter)module.influenceFilter,
        ...
        protected virtual VGO_PS_NoiseModule CreateVgoModule(NoiseModule module)
        {
            var vgoModule = new VGO_PS_NoiseModule()
            {
                ...
                quality = (VgoGltf.ParticleSystemNoiseQuality)module.quality,
        ...
        protected virtual VGO_PS_TrailModule CreateVgoModule(TrailModule module)
        {
            ...
            {
                enabled = module.enabled,
                mode = (VgoGltf.ParticleSystemTrailMode)module.mode,
                ratio = module.ratio,
                ...
                textureMode = (VgoGltf.ParticleSystemTrailTextureMode)module.textureMode,
        ...
        protected virtual VGO_PS_Renderer CreateVgoPsRenderer(ParticleSystemRenderer particleSystemRenderer, Gltf gltf)
        {
            return new VGO_PS_Renderer()
            {
                ...
                renderMode = (VgoGltf.ParticleSystemRenderMode)particleSystemRenderer.renderMode,
                ...
                sortMode = (VgoGltf.ParticleSystemSortMode)particleSystemRenderer.sortMode,
                ...
                alignment = (VgoGltf.ParticleSystemRenderSpace)particleSystemRenderer.alignment,
                ...
                maskInteraction = (VgoGltf.SpriteMaskInteraction)particleSystemRenderer.maskInteraction,
                ...
                motionVectorGenerationMode = (VgoGltf.MotionVectorGenerationMode)particleSystemRenderer.motionVectorGenerationMode,
        ...
        /// <param name="gltf"></param>
        /// <returns></returns>
        protected virtual int GetMaterialIndex(Material material, Gltf gltf)
        {
            if (material == null)
            {
                return -1;
            ...
            var gltfMaterial = gltf.materials.FirstOrDefault(m => m.name.Equals(material.name));
            ...
            return gltf.materials.IndexOf(gltfMaterial);
        }
