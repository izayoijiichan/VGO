...
namespace UniVgo
{
    ...
    public class VgoParticleSystemImporter
    {
        ...
        public virtual ParticleSystem AddComponent(GameObject go, VGO_ParticleSystem vgoParticleSystem, IList<Material> materialList, IList<TextureItem> textureItemList)
        {
            ...
            if (vgoParticleSystem != null)
            {
                ...
                SetModuleValue(particleSystem, vgoParticleSystem.shape, textureItemList);
